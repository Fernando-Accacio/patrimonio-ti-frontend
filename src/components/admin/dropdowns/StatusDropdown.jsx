    ...
    <div className={`relative w-full text-left ${isOpen ? 'z-50' : 'z-10'}`}>
      ...
      {isOpen && (
        <>
          ...
          <div className={`absolute left-0 right-0 bg-white border border-slate-200 rounded-lg shadow-xl z-50 overflow-hidden divide-y divide-slate-100 animate-in fade-in duration-150 ${
