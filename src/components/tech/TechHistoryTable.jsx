...
import { History, ChevronLeft, ChevronRight, Wrench, Search } from 'lucide-react';
                  ...
                  <tr key={tk?.id} className="hover:bg-slate-50 transition align-top">
                    ...
                    <td className="py-4 px-4 pt-5 text-sm leading-relaxed w-[400px] max-w-[400px] whitespace-normal">
                      <div className="text-slate-600 break-words whitespace-pre-wrap leading-relaxed">
                        {expandedTickets[tk.id] ? tk?.descricao_problema : tk?.descricao_problema?.length > 50 ? `${tk.descricao_problema.substring(0, 50)}...` : tk?.descricao_problema || 'Problema não informado.'}
                      </div>
